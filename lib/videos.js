          ...
          .each(function(filename) {
            ...
            var newVideoData = {
              ...
              find: {
                ...
                fullFiles: [ path.join(metalsmith.source(), filename).toString() ],
                inputsPresent: true,
                outputPresent: false
              }
            };
            console.log(yamljs.stringify(videoDataByDirectory[dirname]));
            console.log(yamljs.stringify(newVideoData));
