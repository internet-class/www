      ...
      child_process.exec(titleImageCommandLine + '> output.txt 2>&1', { cwd: workingDir },
        function (err, stdout, stderr) {
          try {
            ...
            throw new Error("title image creation failed: " + err);
          }
        });
    }, function (callback) {
      ...
      child_process.exec(titleMovieCommandLine + ' > output.txt 2>&1', { cwd: workingDir },
        function (err) {
          try {
            ...
            throw new Error("title movie creation failed: " + err);
          }
        });
    }, function (callback) {
      ...
      child_process.exec(encodeCommandLine + ' > output.txt 2>&1', { cwd: workingDir },
        function (err) {
          try {
            ...
            throw new Error("ffmpeg transcode failed: " + err);
          }
        });
    }, function (callback) {
        ...
        child_process.exec(creditsImageCommandLine + ' > output.txt 2>&1', { cwd: workingDir },
          function (err) {
            try {
              ...
              throw new Error("credit large image creation failed: " + err);
            }
          });
      } else {
        callback();
        ...
        child_process.exec(creditsImageCommandLine + ' > output.txt 2>&1', { cwd: workingDir },
          function (err) {
            try {
              ...
              throw new Error("credit image creation failed: " + err);
            }
          });
      } else {
        callback();
        ...
        child_process.exec(encodeCreditsCommandLine + ' > output.txt 2>&1', { cwd: workingDir },
          function (err) {
            try {
              ...
              throw new Error("ffmpeg credits transcode failed: " + err);
            }
          });
      } else {
        callback();
        ...
        child_process.exec(finalCombineCommandLine + ' > output.txt 2>&1', { cwd: workingDir },
          function (err) {
            try {
              ...
              throw new Error("ffmpeg adding preroll failed: " + err);
            }
          });
      }
    }], function (err) {
