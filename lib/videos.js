    ...
    function (callback) {
      ...
      if (finalConcat.length == 1) {
        ...
        _.each(finalConcat, function (file, index) {
          inputString += "-i " + file + " ";
          sarString += "[" + index + ":v:0] setsar=1/1 [sarfix" + index + "]; ";
          filterString += "[sarfix" + index + "] [" + index + ":a:0] ";
        });
        var finalCombineCommandLine = 'ffmpeg ' + inputString + '-filter_complex "' + sarString + filterString +
