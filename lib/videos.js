...
var transcode = function(videoData, config, finished) {
  ...
  var transcodeInfo = getTranscodeInfo(videoData, config.transcode);
  ...
  var titleImageCommandLine = 'convert -matte -background "rgba(256,256,256,0.5)" -font ' +
    georgia + ' -pointsize 48 -gravity center -fill black pango:"' + titleContent + '" ' +
    '-bordercolor "rgba(256,256,256,0.5)" -compose Copy -border 20x20 title.png';
  try {
  ...
  var encodeCommandLine = 'ffmpeg -f concat -safe 0 -i concat -i title.mov -filter_complex ' +
    ...
    'fontsize=40 : x=w-tw-20 : y=20" -c:a libmp3lame -ac 1 -ab 128k out.mp4';
